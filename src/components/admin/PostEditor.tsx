...
import { Save, Eye, ArrowLeft, Globe, FileText, Loader2 } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Excerpt */}
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            <label htmlFor="post-excerpt" className="block text-sm font-medium text-slate-700 mb-2">
              Excerpt <span className="text-slate-400 font-normal">(optional)</span>
            </label>
            <textarea
              id="post-excerpt"
              rows={3}
              ...
              className="w-full text-sm text-slate-700 placeholder:text-slate-300 border-none outline-none resize-none"
            />
          </div>
        </div>
